...
static const _UpdateNotification_type_support_symbol_names_t _UpdateNotification_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ota_update_interfaces, msg, UpdateNotification)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ota_update_interfaces, msg, UpdateNotification)),
  }
};
...
{
  return &::ota_update_interfaces::msg::rosidl_typesupport_cpp::UpdateNotification_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ota_update_interfaces, msg, UpdateNotification)() {
  return get_message_type_support_handle<ota_update_interfaces::msg::UpdateNotification>();
}
